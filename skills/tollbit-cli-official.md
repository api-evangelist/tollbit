<!--
  ...
  source: https://github.com/tollbit/cli/blob/main/skill/tollbit-cli/SKILL.md
  note: TollBit's OFFICIAL published Agent Skill, saved verbatim. Installed by
  end users via `tollbit guide --install <SKILLS_DIR>` (writes tollbit-cli/SKILL.md).
-->
---
name: tollbit-cli
version: 0.2.2
